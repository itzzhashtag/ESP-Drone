// ================================================================
//  Q450 ESP32 Flight Controller  —  v1.5
...
// ----------------------------------------------------------------
//  CHANGES v1.4 → v1.5
//  • Hardware watchdog added (esp_task_wdt) — 250ms timeout
//    If main loop freezes, ESP32 force-reboots and motors cut
//  • Emergency motor kill on every boot — drives ESC pins LOW
//    before Servo library attaches, stops any latched PWM signal
//  • STICK_PITCH_FLIP / STICK_ROLL_FLIP / STICK_YAW_FLIP added
//    Fixes reversed pitch/roll without touching IMU orientation
//  • Motor spin directions corrected — all four motors swapped
//    via bullet connector swap (CW/CCW now match mixer layout)
//  • Pin comments corrected to reflect actual motor directions
// ----------------------------------------------------------------
